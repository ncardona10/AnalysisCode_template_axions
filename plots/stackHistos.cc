...
int main(int argc, char const *argv[])
{
  ...
  TFile *HistoOutputFile = new TFile("/home/n.cardonac/AnalysisCode_SUSY_VBF_Higgsino/plots/results/test_stack.root", "RECREATE");


  TString inputFolder = "/home/n.cardonac/AnalysisCode_SUSY_VBF_Higgsino/RunCode/outPuts/higgsino_nomjj/";
