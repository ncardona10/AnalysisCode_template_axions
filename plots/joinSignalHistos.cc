...
int main(int argc, char const *argv[])
{
  ...
  TFile *HistoOutputFile = new TFile("/home/n.cardonac/AnalysisCode_SUSY_VBF_Higgsino/plots/results/finalSignalHistos.root", "RECREATE");


  TString inputFolder = "/home/n.cardonac/RunCode/outPuts/higgsino_nomjj/";

  vector<TString> folderNames = {"m_n2_100_c1_80_n1_60",
